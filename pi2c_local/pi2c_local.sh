...
\n
....are already downloaded and ready for use\n
##############################################################\n"
...
if [ $INSTALLED == '0' ]; then
	...
	sudo dpkg -i $workingDir/local/i2c-tools_3.1.0-2_armhf.deb
    fi
...
if [ $PY_INSTALLED == '0' ]; then
	...
	sudo dpkg -i $workingDir/local/python-smbus_3.1.0-2_armhf.deb
    fi
